...
<div class="vmi_topbar">
		...
		<div class="row">
			...
			<div class="col-5 mx-auto">
				<div class="search_box align">
					...
					<input class="no_input div_input" placeholder="Pesquise o seu próximo evento" type="search" name="search">
				</div>
			</div>
			<div style="position: relative !important; z-index: 10 !important;" style="text-align: left;" class="col-2">
	...
	<div style="position: relative !important; z-index: 1 !important; background: transparent !important;" class="topButton_row">
		<div class="container-fluid">
			<div class="row">
				<div style="text-align: right;" onclick="window.location.href='<?php echo $config['app_local'] ?>'" class="col-4 topButton_item_row mx-auto">
					<div class="align">
						<div style="background: #9d8abb; !important; border: none;" class="topButton_item">
							<i class="fa-solid fa-cart-shopping fa-sm"></i>
							<span>Comprar</span>
						</div>
					</div>
				</div>
				<div style="text-align: right;" onclick="window.location.href='<?php echo $config['app_local'] . '/revender' ?>'" class="col-4 topButton_item_row mx-auto">
					<div class="align">
				...
				<div style="text-align: right;" onclick="window.open('<?php echo $config['app_local'] ?>/novo-evento', '_blank');" 
					 class="col-4 topButton_item_row mx-auto">
					<div class="align">
