	...
	if (isset($_POST['register'])) {
	    ...
	    if ($user_pass == $user_repass) {
	        ...
	        if ($check_result && $check_result->num_rows > 0) {
	            ...
	            $query = "INSERT INTO users (nome, surname, email, cpf, senha)
						...
						<form method="POST" id="registerForm" action="">
							...
							<div class="input">
								<div class="row">
									...
									<div class="col-10 right_input">
										<input required placeholder="CPF" id="cpf_cnpj" oninput="this.value = formatCPF_CNPJ(this.value)" maxlength="14" type="text" value="<?php if (isset($_POST['user_cpfcnpj'])) { echo $_POST['user_cpfcnpj']; } ?>" name="user_cpfcnpj">
									</div>
								</div>
							</div>
							<div class="input">
							...
							<p onclick="window.location.href='../login'" id="fazer-login" class="cadastrar">FAZER LOGIN</p>
